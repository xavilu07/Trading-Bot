...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(prog="update-experimental-outcomes")
...
def main(argv: list[str] | None = None) -> int:
    ...
    store = ExperimentalSignalStore(data_path)
    ...
    print(f"Experimental outcomes updated: {len(updated)}")
    return 0
